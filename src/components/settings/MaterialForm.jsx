...
const MaterialForm = ({ onClose, onSuccess, isEdit = false, initialData = null, ageCategories = [] }) => {
  ...
  const [imageUrl, setImageUrl] = useState(() => {
    if (isEdit && initialData?.file_url) {
  ...
  const modalContent = (
    <div 
      className="fixed inset-0 bg-gray-600 bg-opacity-75 flex items-center justify-center z-[9999] p-4"
    >
      <motion.div 
            ...
            >
              ...
              <div className="flex justify-center">
                <div className="w-full">
                  <FileUpload
                    mode="file"
                    category="NextGen/materials-bucket"
                    ...
                    accept="*/*"
                    maxSize={50}
                    initialPreview={initialData?.file_url || imageUrl}
                    className="w-full mb-3"
                  />
                  <p className="text-xs text-gray-500 text-center mt-2">
                    Upload PDFs, images, videos, or any educational material (Max 50MB)
                  </p>
                </div>
              </div>
            </motion.div>
