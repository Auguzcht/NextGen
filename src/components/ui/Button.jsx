...
// Import React Icons (add to your package.json if needed)
...
const Button = forwardRef(({
  ...
  // Base style with focus style improvements
  ...
  // NextGen colors used in variants
  const variants = {
    primary: 'bg-nextgen-blue text-white hover:bg-nextgen-blue-dark shadow-md hover:shadow-lg focus:ring-2 focus:ring-nextgen-blue/50 focus:ring-offset-2',
    secondary: 'bg-nextgen-orange text-white hover:bg-nextgen-orange-dark shadow-md hover:shadow-lg focus:ring-2 focus:ring-nextgen-orange/50 focus:ring-offset-2',
    outline: 'bg-transparent border border-nextgen-blue/30 text-nextgen-blue hover:bg-nextgen-blue/5 hover:border-nextgen-blue focus:ring-2 focus:ring-nextgen-blue/30 focus:ring-offset-1',
    ghost: 'bg-transparent text-nextgen-blue hover:bg-nextgen-blue/10 focus:ring-1 focus:ring-nextgen-blue/20',
    ...
    white: 'bg-white text-gray-800 hover:bg-gray-100 shadow-md hover:shadow-lg focus:ring-2 focus:ring-nextgen-blue/20 focus:ring-offset-2 border border-gray-200',
  };
