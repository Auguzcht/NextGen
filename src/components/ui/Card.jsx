...
const Card = ({
  ...
  // Define the glow effect animation with NextGen colors
  const glowVariants = {
    initial: { opacity: 0 },
    hover: { 
      opacity: 0.6, 
          ...
          <div 
            ...
            style={{ 
              background: variant === 'primary' || variant === 'highlight' ? 
                'radial-gradient(circle at center, rgba(48, 206, 228, 0.3) 0%, transparent 70%)' : 
                variant === 'secondary' ? 
                  'radial-gradient(circle at center, rgba(251, 118, 16, 0.3) 0%, transparent 70%)' :
                  'radial-gradient(circle at center, rgba(48, 206, 228, 0.2) 0%, rgba(251, 118, 16, 0.1) 70%, transparent 100%)'
            }}
          />
        </motion.div>
      )}
